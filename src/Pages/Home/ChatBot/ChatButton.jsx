              ...
              >
                <Dialog.Panel className="w-full max-w-md overflow-y-auto text-left  align-middle transition-all transform shadow-xl rounded-2xl">
                  ...
                  <div className="absolute top-5 right-5 z-50 rounded-full ">
                    <button
                      type="button"
                      className="inline-flex justify-center p-2 text-sm font-medium text-blue-900  ag-blue-100 rounded-full hover: ag-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                      onClick={closeModal}
                    >
                      <FaTimes />
                    </button>
