    ...
    const onSubmit = (data) => {
        ...
        fetch(img_hosting_url, {
            ...
            .then((imgResponse) => {
                ...
                const subjectInfo={subject_name:data.subject,subject_code:data.code,description:data.descrip,img_link:imgURL}
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <label className="label">
                    ...
                    />
                    {errors.descrip &&  <span className="mt-1 text-red-500">
            ...
            <div className="form-control rounded-lg border-2 border-violet-600 items-center ">
                ...
                {errors.image &&  <span className="mt-1 text-red-500">
