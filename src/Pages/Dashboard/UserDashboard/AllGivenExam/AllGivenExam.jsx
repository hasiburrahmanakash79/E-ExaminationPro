 ...
 if(data.insertedId){
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
                    ...
                    <div className=' mt-5'>
                        ...
                        <form onSubmit={sendReviews}  action="">
                            <div className='flex gap-2 items-center' >
                                <h1 className='flex gap-1'> <span>Write</span><span> FeedBack:</span> </h1><textarea name='feedback' className="textarea textarea-xs w-full mx-4 textarea-primary" placeholder="Feedback"></textarea>
                            </div>
                            <div className='flex gap-2 mt-2'>
                                <p>Rate Us:</p>
                                <Rating isRequired style={{ maxWidth: 100 }} value={ratings} onChange={setRating}  />
                            </div>
                         <div className='flex justify-end'>
                         <input className='btn  btn-sm primary-bg ' type="submit" value={'Send'} />
                         </div>
                        </form>
                    </div>
            ...
            <button onClick={() => document.getElementById('review').showModal()} className='btn btn-sm primary-bg ms-auto md:me-20'>Give Review</button>
            {info?.map(exam => (
                    ...
                    <div className='mx-5 mt-5 shadow-2xl card md:mx-20 navigation-bar'>
                        <div className='card-body   grid grid-cols-2'>
                            <div className='grid gap-3'>
                                <h2 className='text-green-500 card-title'>Subject: {exam.subject}</h2>
                            ...
                            <div className='text-right grid gap-3'>
                                <p className='text-green-500'>Time You Take: {exam?.timeConsume / 60}min</p>
