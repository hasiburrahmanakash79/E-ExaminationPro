      ...
      <div className='py-6 md:mt-20 dark:text-gray-100'>
        <div className='container flex flex-col items-center justify-center p-4 mx-auto sm:p-10'>
          <p
            ...
            className='p-2 text-sm font-medium text-center uppercase tracki'
          >
            Development team
          </p>
          <h1
            data-aos='fade-down'
            data-aos-duration='1500'
            className='text-3xl font-bold text-center leadi xl:text-5xl'
          >
          ...
          <div className='flex flex-row flex-wrap-reverse justify-center mt-20'>
            <div
              data-aos='fade-right'
              className='flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md shadow-2xl md:w-96 lg:w-80 xl:w-64 bg-white/20 hover:bg-white/30 dark:text-white'
            >
              <img
                alt=''
                className='self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover border-4 border-pink-500 rounded-full dark:bg-gray-500'
            ...
            >
              <img
                alt=''
                className='self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover border-4 rounded-full dark:bg-gray-500'
