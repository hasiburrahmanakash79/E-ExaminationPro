  ...
  return (
    <div className=''>
      <div className='mb-4'>
        ...
        />
        <button className=' ag-blue-500 py-2 px-5  rounded-lg md:ml-2 my-3'>
          Comment
        </button>
      </div>
            ...
            <div className='p-3 shadow-md rounded-md mb-3'>
              ...
              >
                <div className='flex items-center'>
                  ...
                  <p className='pl-3 leading-1  aext-slate-900'>
                    First Comment
                  </p>
                </div>
                ...
                <div className='flex items-center justify-between mt-5'>
                  <div className='flex items-center gap-5'>
                    <p className='cursor-pointer text-sm  '>
                      <span className='text-sm text-red-500'>4 </span> Like
                    </p>
                    <p className='cursor-pointer text-sm  '>
                      <span className='text-sm aext-yellow-500'>5 </span>{' '}
                      Comment
                    </p>
                  </div>
                </div>
              ...
              {/* <div className="p-3 shadow-md rounded-md my-3">
                                ...
                                <div className="pt-2 md:pl-9 pl-4">
                                    ...
                                    <div className="flex items-center justify-between mt-5">
                                        <div className="flex items-center gap-5">
                                            <p className="cursor-pointer text-sm  "><span className="text-sm text-red-500">4 </span> Like</p>
