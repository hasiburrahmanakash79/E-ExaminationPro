...
export default function Notice() {
  return (
    ...
    <div className='md:flex md:gap-20 justify-center items-start pt-20 md:pt-0 px-5'>


      <h2 className='md:pt-32 text-2xl underline  tracking-widest'>Notice</h2>



      <div className="dark:bg-none  dark:text-gray-100 md:w-1/3 px-5 md:pt-40 ">
        ...
        <div className=''>
          <details className='mx-auto'>
            <summary className="py-2 outline-none cursor-pointer text-xl ">Examination Schedule</summary>
        ...
        <div>
          <details>
            <summary className="py-2 outline-none cursor-pointer 
             text-xl">Exam Guidelines</summary>
            <div className="px-4 pb-4 text-slate-400">
              <div className='flex items-center gap-5 pb-5'>
        ...
        <div>
          <details>
            <summary className="py-2 outline-none cursor-pointer 
             text-xl">Due Clearences</summary>
            <div className="px-4 pb-4 text-slate-400">
              <div className='flex items-center gap-5 pb-5'>
