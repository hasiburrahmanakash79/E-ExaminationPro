...
const UnderSingleBlog = ({ smallCard }) => {
  ...
  return (
    <div>
      <div className='mb-5'>
        <div rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark: ag-gray-900">
          <img role="presentation" className="object-cover w-full rounded-b h-60 dark: ag-gray-500 " src={image_url} />
          <div className="p-6 space-y-2">
            ...
            <div className='flex items-center justify-between'>
              <div className='mt-5 flex gap-5'>
                ...
                <FaRegHeart className={`text-2xl ${isLiked ? 'aext-red-500' : ''}`}
