    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-[600px] border-4 border-purple-900 rounded-xl p-4 my-4">
        <div className="w-full mb-4 form-control">
          ...
          <h1 className="flex items-center w-full input input-bordered ">{data?.subjectName}</h1>
        </div>
        ...
        <div className="w-full mb-4 form-control">
          ...
          <h1 className="flex items-center w-full input input-bordered ">{data?.subject_code}</h1>
        </div>
        ...
        <div className="w-full mb-4 form-control">
          ...
          <h1 className="flex items-center w-full input input-bordered ">{user?.displayName}</h1>
        </div>
        <div className="w-full mb-4 form-control">
          <label className="label">
            <span className="font-semibold label-text">Email</span>
          </label>
          <h1 className="flex items-center w-full input input-bordered ">{user?.email}</h1>
        </div>
        ...
        <div className="w-full form-control ">
          ...
          <h1 className="flex items-center w-full input input-bordered ">{studentData?.batch ? studentData?.batch : <span className="text-red-500">Please add batch in update profile</span>}</h1>
        </div>
        ...
        <div className="w-full form-control ">
          ...
          <h1 className="flex items-center w-full input input-bordered ">{data?.date}</h1>
        </div>
