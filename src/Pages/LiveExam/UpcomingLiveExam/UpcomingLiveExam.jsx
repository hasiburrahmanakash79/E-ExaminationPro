    ...
    <div>
      ...
      >
        <div className='w-full mb-4 form-control'>
          ...
          <h1 className='w-full input flex items-center input-bordered '>
            {data?.subjectName}
          </h1>
        </div>
          ...
          <h1 className='w-full input flex items-center input-bordered '>
            {studentData?.batch ? (
              ...
              <span className='text-red-500'>
                Please add batch in update profile
              </span>
            )}
          </h1>
        </div>
        ...
        <div className='flex justify-center w-full mt-4'>
          ...
          <input
            disabled={!studentData?.batch || data?.msg}
        ...
        {data?.msg && (
          <h1 className='text-xl text-center mt-2 text-red-600'>
